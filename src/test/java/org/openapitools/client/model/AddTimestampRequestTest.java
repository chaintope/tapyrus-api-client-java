...
/**
 * Model tests for AddTimestampRequest
 */
public class AddTimestampRequestTest {
    private final AddTimestampRequest model = new AddTimestampRequest();
