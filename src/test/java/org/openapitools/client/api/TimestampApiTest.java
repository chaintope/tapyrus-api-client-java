...
/**
 * API tests for TimestampApi
 */
@Ignore
public class TimestampApiTest {

    private final TimestampApi api = new TimestampApi();
     ...
     */
    @Test
    public void addTimestampTest() throws ApiException {
        AddTimestampRequest addTimestampRequest = null;
        api.addTimestamp(addTimestampRequest);
     ...
     */
    @Test
    public void getTimestampsTest() throws ApiException {
        List<Object> response = api.getTimestamps();
