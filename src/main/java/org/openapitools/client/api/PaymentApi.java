...
public class PaymentApi {
     ...
     * @param paymentRequest &#x60;address&#x60;, &#x60;amount&#x60;を受け取り、アドレスに対して指定した額の資金(tapyrus)を送金します。 任意で&#x60;fee&#x60;を設定し、送金手数料を指定できます。  (optional)
     ...
     */
    public okhttp3.Call transferCall(PaymentRequest paymentRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call transferValidateBeforeCall(PaymentRequest paymentRequest, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = transferCall(paymentRequest, _callback);
        return localVarCall;
     ...
     */
    public PaymentResponse transfer(PaymentRequest paymentRequest) throws ApiException {
        ApiResponse<PaymentResponse> localVarResp = transferWithHttpInfo(paymentRequest);
     ...
     */
    public ApiResponse<PaymentResponse> transferWithHttpInfo(PaymentRequest paymentRequest) throws ApiException {
        okhttp3.Call localVarCall = transferValidateBeforeCall(paymentRequest, null);
        Type localVarReturnType = new TypeToken<PaymentResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * 資金の送金 (asynchronously)
     * 指定したアドレスに任意のtapyrusを送金します。
     * @param paymentRequest &#x60;address&#x60;, &#x60;amount&#x60;を受け取り、アドレスに対して指定した額の資金(tapyrus)を送金します。 任意で&#x60;fee&#x60;を設定し、送金手数料を指定できます。  (optional)
     ...
     */
    public okhttp3.Call transferAsync(PaymentRequest paymentRequest, final ApiCallback<PaymentResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = transferValidateBeforeCall(paymentRequest, _callback);
        Type localVarReturnType = new TypeToken<PaymentResponse>(){}.getType();
