...
import org.openapitools.client.model.GetAddressesResponse;
...
public class AddressApi {
     ...
     */
    public okhttp3.Call createAddressCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createAddressValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createAddressCall(_callback);
        return localVarCall;
     ...
     */
    public String createAddress() throws ApiException {
        ApiResponse<String> localVarResp = createAddressWithHttpInfo();
     ...
     */
    public ApiResponse<String> createAddressWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = createAddressValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * アドレスを生成して返します。 (asynchronously)
     * 受金用のアドレス生成して返します。
     ...
     */
    public okhttp3.Call createAddressAsync(final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAddressValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
     ...
     * @param per 1ページあたりの件数 (optional)
     * @param page ページ番号 (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAddressesCall(Integer per, Integer page, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAddressesValidateBeforeCall(Integer per, Integer page, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAddressesCall(per, page, _callback);
        return localVarCall;
     ...
     */
    public GetAddressesResponse getAddresses(Integer per, Integer page) throws ApiException {
        ApiResponse<GetAddressesResponse> localVarResp = getAddressesWithHttpInfo(per, page);
        return localVarResp.getData();
    }
     ...
     * @param per 1ページあたりの件数 (optional)
     * @param page ページ番号 (optional)
     * @return ApiResponse&lt;GetAddressesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetAddressesResponse> getAddressesWithHttpInfo(Integer per, Integer page) throws ApiException {
        okhttp3.Call localVarCall = getAddressesValidateBeforeCall(per, page, null);
        Type localVarReturnType = new TypeToken<GetAddressesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * これまで生成したアドレスを一覧にして返します。 (asynchronously)
     * これまで生成したアドレスを一覧にして返します。
     * @param per 1ページあたりの件数 (optional)
     * @param page ページ番号 (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getAddressesAsync(Integer per, Integer page, final ApiCallback<GetAddressesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAddressesValidateBeforeCall(per, page, _callback);
        Type localVarReturnType = new TypeToken<GetAddressesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
